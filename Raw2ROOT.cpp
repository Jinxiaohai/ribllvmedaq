...
int main(int argc, char *argv[])
{
  ...
  if(argc == 1)
  ...
  else if(argc == 2)
    {
      //dfname  = datapath;
      dfname += argv[1];
      cout <<"List file of raw data files: " << dfname << endl;
      inter = true;
    }
  else
    {
  ...
  for(int i=0; i<rawdfname.size(); i++)
    {
      ...
      pathrdfn += '/';
      pathrdfn += rdfname;
      cout<<"path of raw data files: " << pathrdfn << endl;
      ...
      tree = 0;
      vmecount += evtc;
      cout <<"VMERead Event Num= " << vmecount << "; File Event Num= "
           <<totalevent <<"; NetLoss Event Num = " << increment-startn <<endl;
