...
# PROG = DAQPC ControlPC OnlinePC MonOnline Raw2ROOT ReadRootFile2D ana_wangyuting TOF_deltaE Chain_root_Al33 Chain_root_Al27   Chain_root_O16
PROG=xiaohai Chain_root_Al33 Chain_root_Al27 Chain_root_O16
...
xiaohai:DIC $(OBJS) xiaohai.o
	$(CPP) -o $@ xiaohai.o $(OBJS) $(CFLAG) $(ROOTLIB) $(SYSLIB) $(CAENLibs) $(Spectrum)
