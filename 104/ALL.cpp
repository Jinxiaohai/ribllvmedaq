...
int main(int argc,char **argv)
{
  ...
  si1_60_p_outputData << setw(20) <<  "Si1 p number" << "   "
                      ...
                      << endl;
  ofstream si1_60_p_three_alpha("../output/si1_60_p_three_alpha.txt");
  si1_60_p_three_alpha << setw(20) << "Three alpha number" << "   "
                       << setw(20) << "channel number" << "   "
                       << setw(20) << "Energy(MeV)" << "   "
                       << endl;
  for (unsigned i = 0; i != CHANNEL_16; ++i)
    {
      ...
      for (int j = 0; j != PEAKS; ++j)
        {
          si1_60_p_three_alpha << setw(20) << j << "   "
                               << setw(20) << X[j] << "   "
                               << setw(20) << alphaEnergy[j] << "   "
                               << endl;
        }
      /// Set Points.
      fitfunc->SetNpx(1000);
  ...
  si1_60_n_outputData << setw(20) <<  "Si1 n number" << "   "
                      ...
                      << setw(20) << "X-axis intercept"
                      << endl;
  ofstream si1_60_n_three_alpha("../output/si1_60_n_three_alpha.txt");
  si1_60_n_three_alpha << setw(20) << "Three alpha number" << "   "
                       << setw(20) << "channel number" << "   "
                       << setw(20) << "Energy(MeV)" << "   "
                       << endl;
  for (unsigned i = 0; i != CHANNEL_16; ++i)
    {
      ...
      for (int j = 0; j != PEAKS; ++j)
        {
          si1_60_n_three_alpha << setw(20) << j << "   "
                               << setw(20) << X[j] << "   "
                               << setw(20) << alphaEnergy[j] << "   "
                               << endl;
        }
