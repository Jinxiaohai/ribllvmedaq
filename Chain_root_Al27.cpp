...
int main()
{
  ...
  TH2F *h_si1_Al27_posi=new TH2F("h_si1_Al27_posi","h_si1_Al27_posi",16,0,16,16,0,16);
  TH2F *h_si2_Al27_posi=new TH2F("h_si2_Al27_posi","h_si2_Al27_posi",16,0,16,16,0,16);
  TH2F *h_si3_Al27_posi=new TH2F("h_si3_Al27_posi","h_si3_Al27_posi",2,0,2,2,0,2);
  TH2F *h_si4_Al27_posi=new TH2F("h_si4_Al27_posi","h_si4_Al27_posi",16,0,16,16,0,16);
...
//         end get data 
    ...
    dist=((si1_60_p_max_e-1760)/200)*((si1_60_p_max_e-1760)/200)+((tof-77)/7)*((tof-77)/7);
    if(dist<=1) 
    {
      if(si1_60_p_max_e>500&&si1_60_n_max_e>500) h_si1_Al27_posi->Fill(si1_60_p_max_index,si1_60_n_max_index);
      if(si2_60_p_max_e>500&&si2_60_n_max_e>500) h_si2_Al27_posi->Fill(15-si2_60_n_max_index,si2_60_p_max_index);
      if(si3_qsd300_max_e>500) h_si3_Al27_posi->Fill(si3_qsd300_max_x,si3_qsd300_max_y);
      for (int i=0;i<16;i++)
      {
        if(si4_1000_p_max_e>500) h_si4_Al27_posi->Fill(i,15-si4_1000_p_max_index);
      }
      ...
      {
      //Si1
        if (si1_60_p_max_e>500&&si1_60_n_max_e>500&&i==si1_60_p_max_index)
	{
	...
	h_si1_60_n_sum->Fill(si1_60_n[i]);
      ...
      //Si2
        if (si2_60_p_max_e>500&&si2_60_n_max_e>500&&i==si2_60_p_max_index)
	{
	...
	h_si2_60_n_sum->Fill(si2_60_n[i]);
      ...
      //Si4
        if (si4_1000_n_max_e>500&&i==si4_1000_p_max_index)
	{
...
//    cout<<si1_60_p_max_e<<endl;
 ...
 // h_si1_Al27_posi->Write();
 // h_si2_Al27_posi->Write();
 // h_si3_Al27_posi->Write();
 // h_si4_Al27_posi->Write();
 // ribll_gdr->Write();
  rootf->Write();
  rootf->Close();
  Al27_purity=Al27_count*1.0/count;
  cout<<"Number of total entries:"<<totalentries<<endl;
  cout<<"Number of events:"<<count<<endl;
  cout<<"Number of Al27:"<<Al27_count<<endl;
  cout<<"Purity of Al27:"<<Al27_purity*100<<"%"<<endl;
